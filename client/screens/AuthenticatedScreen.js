...
//   const fetchUserDonations = async (userId) => {
//     try {
//       // Query for donations where userId matches
//       const donationsQuery = query(
//         collection(db, "donations"),
//         where("userId", "==", userId),
...
//         if (donations.length > 0 && donations[0].donationDate) {
//           const lastDonationDate = donations[0].donationDate;
//           const nextDate = calculateNextDonationDate(lastDonationDate instanceof Date ? 
//             lastDonationDate : 
//             new Date(lastDonationDate.seconds * 1000));
...
//           <TouchableOpacity 
//             style={styles.secondaryButton}
//             onPress={() => navigation.navigate("Потреби")}
//           >
//             <View style={styles.buttonIconContainer}>
//               <Ionicons name="medkit-outline" size={32} color={Colors.primary500} />
//             </View>
...
//                   <View style={styles.donationDateContainer}>
//                     <Text style={styles.donationDate}>
//                       {formatDate(donation.donationDate instanceof Date ? 
//                         donation.donationDate : 
//                         new Date(donation.donationDate.seconds * 1000))}
//                     </Text>
//                   </View>
//                   <View style={styles.donationDetails}>
//                     <Text style={styles.donationCenter}>
